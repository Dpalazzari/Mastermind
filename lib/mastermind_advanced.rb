require_relative 'advanced_module'

class MastermindAdvanced
  include AdvancedInstructions
  ...
  def generate_sequence
     @new_game_array = @game_array.sample(6)
  end
  ...
  def check_guess
    ...
    answer_accepted
    win  if how_many_in_sequence_are_right == 6
  ...
  def how_many_in_sequence_are_right
    ...
    puts "You have #{correct_colors} colors in the correct position, of your 6 choices."
    correct_colors
  end
