require_relative 'intermediate_module'

class MastermindIntermediate
  include IntermediateInstructions
  ...
  def generate_sequence
     @new_game_array = @game_array.sample(5)
  end
  ...
  def check_guess
    ...
    answer_accepted
    win  if how_many_in_sequence_are_right == 5
  ...
  def how_many_in_sequence_are_right
    ...
    puts "You have #{correct_colors} colors in the correct position, of your 5 choices."
    correct_colors
  end
